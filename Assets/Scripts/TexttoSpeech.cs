...
public class TextToSpeech : MonoBehaviour
{
    ...
    public async void MakeAudioRequest(string message, UnityAction onPlaybackComplete)
    {
        ...
        using (var www = UnityWebRequestMultimedia.GetAudioClip(audioPath, AudioType.MPEG))
        {
            ...
            //StartCoroutine(WaitForAudioToEnd(onPlaybackComplete));
            audioSource.Play();
    ...
    private IEnumerator WaitForAudioToEnd(UnityAction onPlaybackComplete)
    {
