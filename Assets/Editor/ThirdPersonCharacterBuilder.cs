...
{
    private const string ANIMATOR_PATH = "Assets/Starter Assets/Runtime/ThirdPersonController/Character/Animations/StarterAssetsThirdPerson.controller";
    private const string INPUT_ASSET_PATH = "Assets/Starter Assets/Runtime/InputSystem/StarterAssets.inputactions";
    private const string CAMERA_TARGET_OBJECT_NAME = "CameraTarget";

    private const string LANDING_AUDIO_PATH = "Assets/Starter Assets/Runtime/ThirdPersonController/Character/Sfx/Player_Land.wav";
    private const string FOOTSTEP_AUDIO_PATH = "Assets/Starter Assets/Runtime/ThirdPersonController/Character/Sfx/Player_Footstep_01.wav";
